...
# Note: CardSequenceDialog and PatternDetectionEngine should be imported here
# or inside methods to avoid circular dependencies.


class DesignerViewTextileMethods:
    """
    Mixin class implementing textile-specific designer methods.
    """

    def detect_pattern_from_image(self, *args):
        """Detect and extract pattern from any image (Google, photos, etc.)."""
        from sj_das.ai.procedural_generator import PatternDetectionEngine
    ...
    def show_card_sequence_editor(self, *args):
        ...
        from sj_das.ui.dialogs.loom_import_dialog import CardSequenceDialog
        ...
        try:
            ...
            if image_q.isNull():
                QMessageBox.warning(
                    self,
                    "No Design",
                    "Please create or import a design first.")
                return
